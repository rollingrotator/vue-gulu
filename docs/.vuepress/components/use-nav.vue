...
<script>
  import HotsNav from '../../../src/nav/nav'
  import HotsNavItem from '../../../src/nav/nav-item'
  import HotsSubNav from '../../../src/nav/sub-nav'
  export default {
    name: "use-nav",
    components: {HotsNav, HotsNavItem, HotsSubNav},
    data () {
      return {
        selected: ['culture']
      };
